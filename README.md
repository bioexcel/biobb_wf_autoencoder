...
This instruction ensures that the installed **torch** dependency will match your **architecture**. <br>
To remove the subdir override:<br>
`conda config --env --remove-key subdir`<br>
Check:<br>
