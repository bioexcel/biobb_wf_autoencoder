...
project = u'biobb_wf_autoencoder'
...
htmlhelp_basename = 'biobb_wf_autoencoder_doc'
...
latex_documents = [
    (master_doc, 'biobb_wf_autoencoder.tex', u'biobb_wf_autoencoder Documentation',
...
man_pages = [
    (master_doc, 'biobb_wf_autoencoder', u'biobb_wf_autoencoder Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'biobb_wf_autoencoder', u'biobb_wf_autoencoder Documentation',
     author, 'biobb_wf_autoencoder', 'biobb_wf_autoencoder molecular dynamics analysis building blocks',
     'Miscellaneous'),
]
